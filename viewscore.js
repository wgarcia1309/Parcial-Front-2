...
function datagraph(empresa) {
    for (i = 1; i <= 5; i++) {
        ...
        r1 = empresa.child(`Historial/${localStorage.employeeuid}/Pregunta ${i}/respuesta`).val();
...
function getdata() {
    ...
    firebase.database().ref('/Empresas/' + localStorage.uid).once('value', function (empresa) {
        console.log(empresa.child('Historial/' + localStorage.employeeuid+'/Pregunta 1').val());
        ...
        container.innerHTML += `
        <section class="center-space ml-3 mr-3">
            <div class="questions-bg mt-2 mb-3 p-3 shadow-lg">
                <div class="form-group">
                    ...
                    <h3>respuesta:${empresa.child('/Historial/' + localStorage.employeeuid + '/Pregunta 1/respuesta').val()}</h3>
                    ...
                    <h3>respuesta:${empresa.child('/Historial/' + localStorage.employeeuid + '/Pregunta 2/respuesta').val()}</h3>
                    ...
                    <h3>respuesta:${empresa.child('Historial/' + localStorage.employeeuid + '/Pregunta 3/respuesta').val()}</h3>
                    ...
                    <h3>respuesta:${empresa.child('Historial/' + localStorage.employeeuid + '/Pregunta 4/respuesta').val()}</h3>
                    ...
                    <h3>respuesta:${empresa.child('Historial/' + localStorage.employeeuid + '/Pregunta 5/respuesta').val()}</h3>
